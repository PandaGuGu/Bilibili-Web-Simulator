...
import { CommentSection } from '@/features/user/components/CommentSection'
...
export default function VideoDetail() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // 获取弹幕
      const dRes = await api.getDanmaku(Number(id))
      if (dRes.success) setDanmakuList(dRes.danmaku)
      setLoading(false)
    }
    load()
  }, [id, currentUser])
